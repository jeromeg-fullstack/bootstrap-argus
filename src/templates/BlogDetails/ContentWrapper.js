              ...
              <div className='author-info mt-sm-40'>
                ...
                <div className='author-txt'>
                  ...
                  <div className='member-social-icons'>
                    <a
                      href={`https://facebook.com/${post.author.socials.facebook}`}
                      target='_blank'
                      rel='noopener noreferrer'>
                      <i className='fa fa-facebook' />
                    </a>
                    <a
                      href={`https://twitter.com/${post.author.socials.twitter}`}
                      target='_blank'
                      rel='noopener noreferrer'>
                      <i className='fa fa-twitter' />
                    </a>
                    <a
                      href={`https://linkedin.com/company/${post.author.socials.linkedin}`}
                      target='_blank'
                      rel='noopener noreferrer'>
